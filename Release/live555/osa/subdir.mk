...
live555/osa/%.o: ../live555/osa/%.c
	...
	/usr/local/cuda-8.0/bin/nvcc -DALLOW_RTSP_SERVER_PORT_REUSE=1 -I/usr/include/glib-2.0 -I/usr/include/gstreamer-1.0 -I/usr/lib/aarch64-linux-gnu/include -I/usr/lib/aarch64-linux-gnu/glib-2.0/include -I/usr/lib/aarch64-linux-gnu/gstreamer-1.0/include -I../live555/osa/include -I../live555/liveMedia/include -I../live555/groupsock/include -I../live555/UsageEnvironment/include -I../live555/BasicUsageEnvironment/include -I/usr/lib/x86_64-linux-gnu/glib-2.0/include -O3 -gencode arch=compute_50,code=sm_50  -odir "live555/osa" -M -o "$(@:%.o=%.d)" "$<"
